...
app.MapGet("/api/product/special", ([AsParameters] ProductRequest req, ApplicationDbContext _db) =>
{
if (req.ProductName != null)
{
return _db.Products.Where(u => u.Name.Contains(req.ProductName)).Skip((req.Page - 1) * req.PageSize).Take(req.PageSize);
}
